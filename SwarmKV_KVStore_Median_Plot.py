...
pattern = re.compile(r"50%:\s+(\d+)ns\.")
logs_dir = "logs_KVStore"

client_counts = []
get_latencies = []
update_latencies = []
print(f"{'Folder':<35} {'GET 50% Avg Latency (ns)':<30} {'UPDATE 50% Avg Latency (ns)':<30}")
print("=" * 95)
...
plt.title("Average 50th Percentile Latency vs Number of Clients")
...
plt.tight_layout()
plt.savefig("SwarmKV-KVStore-Median.png")
plt.show()

print("Plot saved as 'SwarmKV-KVStore-Median.png'.")